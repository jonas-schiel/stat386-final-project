...
### simple_eda
Another function we have allows for some basic eda and creates a correlation matrix for the factors that are used in our dataset and how they influence each other. This function allows users who are interested in specifically election years to filter by those years.
```{python}
